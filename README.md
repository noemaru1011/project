...
> 住吉さんが、12月1日から12月10日（もしくは未定）の間、○○病院で、病気休暇中
...
- 大分類（1大隊〜4大隊）: 4つの学生寮
  - 中分類: 各階ごと（例: 1大隊1階 = 11中隊）
    - 小分類: 中隊をさらに3分割（例: 111, 112, 113小隊）
...
- 管理者アカウントは学生データにアクセスできますが、パスワードは変更できません。
- 学生アカウントは学生データにアクセスできないですが、自身のパスワードは変更できます。
